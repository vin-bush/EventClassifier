...
public sealed class Configuration
{
    ...
    public static AzureOpenAIEmbeddingsConfig AzureOpenAIEmbeddings =>
        LoadSection<AzureOpenAIEmbeddingsConfig>();
    ...
    public static ChatGPTRetrievalPluginConfig ChatGPTRetrievalPlugin =>
        LoadSection<ChatGPTRetrievalPluginConfig>();
    ...
    public static AzureCosmosDbMongoDbConfig AzureCosmosDbMongoDb =>
        LoadSection<AzureCosmosDbMongoDbConfig>();
